...
/**
 * Esta clase es la encargada de mostrar las instrucciones
...
public class Instrucciones extends JPanel{
    ...
    private Image Fondo = new ImageIcon(getClass().getClassLoader().getResource("instru.png")).getImage();
  ...
  */
    ...
    public void volver(){
        volver= new JLabel();
        volver.setBounds(320, 400, 100, 100);
